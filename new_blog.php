...
if (isset($_POST['btn-post'])) {
    ...
    $tags = strip_tags($_POST['txt_tags']);
...
// Allows certain file formats
    ...
    $auth_user->post_blog($title, $tags, $category, $blog, $user_id, $image);
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index_1.php">Blog</a>
                </div>
        ...
        <div class="container-fluid" style="margin-top:80px;">
            ...
            <div class="container">
                ...
                <form method="post" class="form-signin" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="txt_tags" placeholder="Enter Tags"/>
                    </div>
                    <div class="form-group">
                        <select  name="categories" class="form-control" placeholder='Select the category'>
